...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Mar 2022 pada 15.45
...
(4, 'migel@gmail.com', '2022-03-08 21:26:01'),
(5, 'migel@gmail.com', '2022-03-10 21:14:29'),
(6, 'migel@gmail.com', '2022-03-10 21:15:45');
...
(1, 1, 'playstation 5', 'console', 'putih', 'https://asset.kompas.com/crops/OShkHBI40cCFj6mMFFcYmhbhBaw=/187x12:1126x638/750x500/data/photo/2020/06/12/5ee2bae6901d6.jpg', 'playstation 5 terbaru', '123', 3),
(3, 1, 'playstation 4', 'console', 'hitam', 'https://cdn1-production-images-kly.akamaized.net/Tib_XTBmEyghebeVYZPvqM0HDCY=/640x360/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/3218222/original/083216700_1598339935-playstation-4-pro-vertical-product-shot-01.jpg', '', '1234', 3),
...
CREATE TABLE `rekeningtoko` (
  ...
  `no_rekening_toko` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `rekeningtoko`
--

INSERT INTO `rekeningtoko` (`id_rekening_toko`, `no_rekening_toko`, `bank_rekening_toko`, `status_rekening_toko`, `created_at`) VALUES
(2, 1122334455, 'Mandiri', 'aktif', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tarifsewa`
--
...
--
-- Dumping data untuk tabel `tarifsewa`
--
...
(17, 7, 40000, 1, '0000-00-00 00:00:00'),
(18, 7, 100000, 3, '0000-00-00 00:00:00'),
(19, 7, 210000, 7, '0000-00-00 00:00:00'),
...
(14, 'migeell', 'migel@gmail.com', '$2y$10$V4ZlCTHc7pLSLiejer.97Obj2OzuVfY4fGN2/5NRFVTqoC/SPfWXm', 'empty', 'empty', 'empty', '0000-00-00', 'empty', 'empty', 'admin', 'belum', 'yes', '2022-02-22 22:20:17', '2022-02-22 22:20:17');
...
--
ALTER TABLE `loginhistory`
  MODIFY `id_login_history` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT untuk tabel `tarifsewa`
--
ALTER TABLE `tarifsewa`
  MODIFY `id_tarif_sewa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
-- Ketidakleluasaan untuk tabel `tarifsewa`
--
ALTER TABLE `tarifsewa`
