...
--
-- RELATIONSHIPS FOR TABLE `customerservice`:
--
...
--
-- RELATIONSHIPS FOR TABLE `detailbooking`:
--   `id_booking`
--       `booking` -> `id_booking`
--   `id_produk`
--       `produk` -> `id_produk`
...
--
-- RELATIONSHIPS FOR TABLE `detailcart`:
--   `id_produk`
--       `produk` -> `id_produk`
--   `id_cart`
--       `cart` -> `id_cart`
...
--
-- RELATIONSHIPS FOR TABLE `loginhistory`:
--
...
--
-- RELATIONSHIPS FOR TABLE `nomorhphistory`:
--   `id_user`
--       `user` -> `id_user`
--
...
--
-- RELATIONSHIPS FOR TABLE `rekeningtoko`:
--
...
--
-- RELATIONSHIPS FOR TABLE `tarifsewa`:
--   `id_produk`
--       `produk` -> `id_produk`
--
...
--
-- RELATIONSHIPS FOR TABLE `usertoken`:
--
...
(21, 'danthonynathanael@gmail.com', 'Naj+wwKil15xYBn1I88EKt4o9G/yUyVUu7k4EzWUJKg=', '2022-03-03 20:42:25');
...
--
ALTER TABLE `loginhistory`
  MODIFY `id_login_history` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
