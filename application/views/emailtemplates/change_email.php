...
<body>
	...
	-->
						<a href="<?= base_url('auth/changeemail?email=' . $email . '&token=' . urlencode($token)) ?>" class="btn" style="align-items:center; justify-content:center; display: block; margin:0 auto;">Konfirmasi</a><br><br>

						<hr>
						<p style="text-align:center;font-size: 10px;">Apabila Anda tidak mengganti Email pada SharedGame, mohon untuk tidak menekan tombol Konfirmasi.</p>
