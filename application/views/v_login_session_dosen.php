...
<form autocomplete='off' class='form' method="POST" action="<?php echo base_url(). 'Dosen/proses_session_login'; ?>">
  <div class='control'>
    <h1>
      LOGIN SESSION
    </h1>
  ...
  <div class='control block-cube block-input'>
    <input name='password' placeholder='NIDN' type='password'>
    <div class='bg-top'>
      <div class='bg-inner'></div>
    </div>
    <div class='bg-right'>
  ...
  <button class='btn block-cube block-cube-hover' type='button'>
    ...
    <div class='bg'>
      ...
      <input class='text' type="submit" name="login">
  </button>
