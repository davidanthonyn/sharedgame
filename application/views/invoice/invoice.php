    ...
    <div class="my-5 page" size="A4">
        <div class="p-5">
            <section class="top-content bb d-flex justify-content-between">
                <div class="logo">
                    <img src="<?php echo base_url('assets/images/SharedGameController.png'); ?>" alt="" class="img-fluid">
                </div>
                <div class="top-left">
            ...
            <footer>
                ...
                <p class="m-0 text-center">
                    Sewa Game Cuma Di - <a href="<?php echo base_url(); ?>"> sharedgame.tech </a>
                </p>
                <div class="social pt-3">
                    ...
                    <span class="pr-2">
                        ...
                        <span>cs@sharedgame.tech</span>
                    </span>
                    <span class="pr-2">
                        <i class="fab fa-facebook-f"></i>
                        <span>/sharedgame</span>
                    </span>
                    <span class="pr-2">
